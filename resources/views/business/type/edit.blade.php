    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Update Business
                ...
                <form method="post" action="{{route('update.business.type',$business_type->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-layout">
                        <div class="row mg-b-25">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="type_name" value="{{ $business_type->type_name }}" >
                                </div>
                            </div><!-- col-4 -->
                        ...
                        <div class="col-lg-4">
                            <label class="ckbox">
                                <input type="checkbox" name="isActive" value="1" <?php if ($business_type->isActive == 1) {
                                    echo "checked"; }  ?> >
                                <span>Is Active</span>
                            </label>
